...
카메라와 LiDAR 토픽을 ROS 2로 다시 publish합니다.
...
ArUco marker detector 노드를 실행합니다.
...
QGC에서 waypoint를 찍으면 PX4 mission item을 global goal로 받고, LiDAR 기반 local target을 계속 갱신하면서 rover setpoint를 publish합니다.
...
빨간 마커는 QGC/global 최종 목표점, 초록 마커는 로컬 플래너가 현재 추종하는 local target입니다.
